...
profile_file = 'june_2022_profile.csv' ###user input
...
lines = []
lines.append('MDB2004 Mill. L. vertical initial conditions Jan. 15, 2004 (Day 15) estimated Lake Profiles 2004.xls                                ')
lines.append('\nused 0.65 x EC uS/cm to derive TDS in mg/l  (130 active layers in this file) -1 C mdb 4/19/05')
...
for i in range(0, len(DOarr)):
    ...
    lines.append(l)
lines.append('\n')    
with open('../NewExNoAction_2022/mvpr1.npt',"w") as update:
