...
for analog_year in analog_years:
    print(analog_year)
    df_flow = pd.read_csv('flow_data/flow_data_base.csv', thousands=',' , index_col = 0, parse_dates = True)
   ...
   # lines.append(f"\n{JDAY_end : >8}{0.0 : >8}\n")
    ...
    os.system("WINEPREFIX=~/.wine_cequal wine w2_cvf_millerton_2_1_07.exe")
